...
const CreateRecipe = (props) => {
  ...
  const [createDetails, toggleCreateDetails] = useState(false)
  ...
  return (
    <div>
      <Button id="dash-button" onClick={() => toggleCreateOpen(true)}>
        CREATE RECIPE
      </Button>
      <Modal createOpen={createOpen} dialogClassName="addFood">
        <button
          id="dash-button"
          onClick={() => props.toggleCreateDetails(true)}
        ></button>
        {/* <Modal createDetails={createDetails} dialogClassName="addFood">
          ...
          <Modal.Body>
            <form onSubmit={props.submitRecipe}>
              ...
              <button
                type="submit"
                onClick={() => props.toggleCreateDetails(false)}
              >
                Create
              </button>
            </form>
